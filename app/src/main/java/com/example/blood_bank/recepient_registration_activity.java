...
public class recepient_registration_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        donar_backbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(recepient_registration_activity.this,loginactivity.class));
            }
        });
        ...
        donar_register_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                {
                    Toast.makeText(recepient_registration_activity.this,"select your blood group",Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                */
                    rauth.createUserWithEmailAndPassword(don_email,don_password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            {
                                Toast.makeText(recepient_registration_activity.this,"sign up dont successfully due to"+task.getException().toString(),Toast.LENGTH_SHORT).show();
                            ...
                            else
                            {
                                ...
                                userinfo.put("search","recipient_cus"+don_bloodgroup);
                                userref.updateChildren(userinfo).addOnCompleteListener(new OnCompleteListener() {
                                    @Override
                                    public void onComplete(@NonNull Task task) {
                                        if(task.isSuccessful())
                                        {
                                            Toast.makeText(recepient_registration_activity.this,"data is successfully inserted",Toast.LENGTH_SHORT).show();
                                        }
                                        else
                                        {
                                            Toast.makeText(recepient_registration_activity.this,"error"+task.getException().toString(),Toast.LENGTH_SHORT).show();
                       ...
                       if(resulturi!=null)
                       {
                           ...
                           uploadTask.addOnFailureListener(new OnFailureListener() {
                               ...
                               public void onFailure(@NonNull Exception e) {
                                   Toast.makeText(recepient_registration_activity.this,"image upload failed",Toast.LENGTH_SHORT).show();
                                           ...
                                           public void onSuccess(Uri uri) {
                                              ...
                                              userref.updateChildren(imagemap).addOnCompleteListener(new OnCompleteListener() {
                                                  ...
                                                  public void onComplete(@NonNull Task task)
                                                  {
                                                    if(task.isSuccessful())
                                                    {
                                                        Toast.makeText(recepient_registration_activity.this,"picture url is successfully added",Toast.LENGTH_SHORT).show();

                                                    }
                                                    else
                                                    {
                                                        Toast.makeText(recepient_registration_activity.this,task.getException().toString(),Toast.LENGTH_SHORT).show();
                           ...
                           startActivity(new Intent(recepient_registration_activity.this,MainActivity.class));
